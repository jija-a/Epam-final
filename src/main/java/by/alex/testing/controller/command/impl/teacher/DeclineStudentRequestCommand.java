...
public final class DeclineStudentRequestCommand implements Command {
    ...
    public ViewResolver execute(final HttpServletRequest req,
        ...
        if (ParameterValidator.isNullOrEmpty(courseIdParam, studentIdParam)) {
        ...
        if (this.refuseRequest(courseId, studentId, teacher)) {
            String msg = MessageManager.INSTANCE
                    .getMessage(MessageConstant.DECLINE_SUCCESS);
    ...
    private boolean refuseRequest(final long courseId,
        ...
        return teacherService.declineRequest(courseUser, teacher);
    }
}
